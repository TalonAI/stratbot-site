  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          ...
          {/* Command Stack */}
          <div className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-mosaics-teal hover:shadow-xl transition transform hover:-translate-y-1">
            <h2 className="text-2xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-mosaics-dark to-mosaics-purple">Command Stack</h2>
            <p className="text-gray-700 mb-6">
              The Command Stack helps SMBs turn internal processes into custom GPT-powered apps. We help you identify high-impact workflows, build a tailored AI assistant, and deploy it as a branded tool your entire company can use.
            </p>
            <ul className="space-y-2 mb-8">
              {[
                "Workflow Audit & GPT Opportunity Mapping",
                "Custom GPT Logic Design (Clarity Stack)",
                "Company-Wide App Deployment (AI Wrapper)",
              ].map((item) => (
                <li key={item} className="flex items-start">
                  {checkSvg}
                  <span>{item}</span>
