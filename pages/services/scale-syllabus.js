    ...
    <>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="text-gray-700 mb-8">
          Dive deep into each week’s agenda, pre-work, live exercises, and
          post-session deliverables—designed to install a robust, team-wide
          operating rhythm.
        </p>

        {weeks.map((w, i) => (
          <details key={i} className="mb-4 border rounded-lg overflow-hidden">
            <summary className="bg-gray-100 px-4 py-2 cursor-pointer font-semibold hover:bg-gray-200">
              {w.title}
            </summary>
