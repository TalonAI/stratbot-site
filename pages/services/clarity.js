        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-mosaics-teal mb-12">
          ...
          <div className="space-y-6 mb-8">
            <div className="bg-mosaics-gray p-6 rounded-xl">
              <h3 className="text-xl font-semibold mb-2 text-mosaics-purple">Strategic Decision Framework</h3>
            ...
            <div className="bg-mosaics-gray p-6 rounded-xl">
              <h3 className="text-xl font-semibold mb-2 text-mosaics-purple">Priority Mapping</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-mosaics-gray p-6 rounded-xl">
              <h3 className="text-xl font-semibold mb-2 text-mosaics-purple">Action Plan Development</h3>
              <p className="text-gray-700">
