...
export default function Blog() {
  const blogPosts = [
    {
      id: 5,
      title: "From Bottleneck to Breakthrough: How a Custom GPT Becomes a Company-Wide App",
      excerpt:
        "Most delays aren’t caused by tools — they’re caused by logic gaps. Here’s how to turn one bottleneck into a shareable GPT-powered app for your entire company.",
      date: "May 26, 2025",
      readTime: "6 min read",
      slug: "from-bottleneck-to-breakthrough",
    },
    {
      id: 4,
    ...
    <div className="bg-blue-50 min-h-screen text-gray-800 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-mosaics-dark to-mosaics-purple">
          Insights from <span className="text-purple-700">Mos</span><span className="text-teal-500">AI</span><span className="text-purple-700">cs AI</span>
        </h1>
        ...
        <div className="space-y-10">
          {blogPosts.map((post) => (
            <div
              key={post.id}
              className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-mosaics-teal hover:shadow-2xl hover:-translate-y-1 transition transform duration-200"
            >
