          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="hidden md:flex md:items-center text-lg">
              <Link href="/team" legacyBehavior>
                <a className="text-gray-700 hover:text-blue-600 ml-12">Team</a>
              </Link>
              <Link href="/contact" legacyBehavior>
                <a className="text-gray-700 hover:text-blue-600 ml-12">Contact</a>
              </Link>
              <Link href="/blog" legacyBehavior>
                <a className="text-gray-700 hover:text-blue-600 ml-12">Blog</a>
              </Link>
            </div>
